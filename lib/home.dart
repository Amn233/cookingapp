                                ...
                                children: [
                                  ...
                                  Positioned(
                                    left: 10,
                                      ...
                                      right: 0,
                                      child: Container(
                                          child: Text(recipelist[index].applabel,style: TextStyle(fontSize: 20,color: Colors.white),))),
                                  Positioned(
                                      right: 10,
                                      child: Container(
                                          decoration: BoxDecoration(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              Text(recipelist[index].appcalories.toString().substring(0,5),style: TextStyle(fontSize: 20,color: Colors.white),),
                                            ],
                                          )))
